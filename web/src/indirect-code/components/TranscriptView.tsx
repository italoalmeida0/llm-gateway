...
{/* Floating top-left: sidebar toggle only (Back to Gateway lives above
    New Conversation in the sidebar). Hidden while the installed-app
    titlebar is visible — it owns the toggle there (rc-transcript-toggle). */}
<div class="rc-transcript-toggle absolute top-2 left-2 z-20 flex items-center gap-1.5">
  <button

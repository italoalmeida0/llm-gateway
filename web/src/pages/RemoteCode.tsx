                ...
                <div class="flex flex-1 min-w-0 flex-wrap items-center gap-0.5 text-xs text-ink-400">
                  ...
                  <div>
                    <button ref={modeBtn} data-menubtn aria-label="Agent mode and skills" aria-expanded={modeMenuOpen()}
                      ...
                      <Iconify icon={agentMode() === "plan" ? "lucide:list-checks" : agentMode() === "learning" ? "lucide:graduation-cap" : agentMode() === "talk" ? "lucide:messages-square" : "lucide:hammer"} size={14} />
                  ...
                  <div>
                    ...
                    <FloatMenu anchor={() => accessBtn} open={accessMenuOpen()} placement="top-start" width="22rem">
                      ...
                      <Show when={agentMode() !== "build"}>
                        <div class="px-2 py-2">
                          <p class="text-[11px] text-ink-500">{agentMode() === "plan" ? "Plan explores freely but never mutates. Edit, create and patch are disabled." : agentMode() === "talk" ? "Talk chats with web research. No workspace access at all." : "Learning observes read-only. Edit, create, patch and code execution are disabled."}</p>
                          <div class="mt-1.5 flex flex-wrap gap-1">
                            ...
                            <For each={agentMode() === "plan" ? ["write", "edit", "patch"] : agentMode() === "talk" ? ["read", "write", "edit", "patch", "search", "inspect", "bash", "python", "glob"] : ["write", "edit", "patch", "bash", "python"]}>

...
const searchSchema = `{"type":"object","required":["pattern"],"properties":{"pattern":{"type":"string","description":"Regex (isRegex=true) or literal substring to find."},"path":{"type":"string","description":"Workspace-relative file or dir scope (default '.')."},"isRegex":{"type":"boolean"},"include":{"type":"array","items":{"type":"string"}},"exclude":{"type":"array","items":{"type":"string"}},"maxResults":{"type":"number"},"contextLines":{"type":"number"},"caseSensitive":{"type":"boolean"},"respectGitignore":{"type":"boolean"},"maxFileBytes":{"type":"number"}}}`
